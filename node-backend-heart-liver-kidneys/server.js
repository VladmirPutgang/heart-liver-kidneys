/* The server will recieve a url request that specifies the users organ choice by adding /organ to the url. After recieving the user's organ choice, the server randomly chooses 1-3 which corresponds to the computers organ choice. Win/loss criteria is evaluated on the server, and the server responds to the browser with a JSON specifying the user's choice, the computer's choice, and a boolean condition indicating wether the player won.
*/
